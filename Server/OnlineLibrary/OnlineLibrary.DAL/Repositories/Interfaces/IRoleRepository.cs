...
public interface IRoleRepository : IBaseRepository<RoleEntity>
{
    ...
    Task<bool> CheckUserHasRoleAsync(Guid userId, Guid roleId, CancellationToken cancellationToken = default);
    Task SetRoleToUserAsync(UserRoleEntity userRole, CancellationToken cancellationToken = default);
